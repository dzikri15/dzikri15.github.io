...
// ← this is the only place the number of pictures is hard‑coded
const defaultHeartImages = Array.from(
    { length: 14 },                 // ← change this value to whatever
    (_, i) => `images/img${i + 1}.jpg`
);

const heartImages = [
    ...(window.dataCCD?.data?.heartImages || []), // optional override
    ...defaultHeartImages
];

const numGroups = heartImages.length;            // used in the for‑loop below
...
const ringTexts = [
  ...
  "♡Happy Birthday Rei♡",//untuk deskripsi planet layer 3
  "29/03/2026",//untuk deskripsi planet layer 4
